...
class CreatePostView extends ConsumerWidget {
  ...
  void settingModalBottomSheet(context,createPostController) {
                    ...
                    children: [
                      GestureDetector(
                        onTap: () async {
                          ...
                          createPostController.imagePickerMethod(ImageSource.camera);
                        },
                        child: const Column(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: [
                      ...
                      GestureDetector(
                        onTap: () {
                          Navigator.pop(context);
                          createPostController.imagePickerMethod(ImageSource.gallery);
                        },
                        child: const Column(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: [
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
                  ...
                  child: Padding(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                          ...
                          border: Border.all(
                            color: createPostController.isThoughtsNull?Colors.red: const Color(0xffE8ECF4),
                          ),
                          borderRadius: BorderRadius.circular(15)
                      ),
                      child: TextFormField(
                        maxLines: 4,
                        controller: createPostController.thoughtsController,
                        cursorColor: createPostController.isThoughtsNull?Colors.red:Colors.black,
                        onChanged: (val){
                          createPostController.clearThoughtsWarning(val);
                        },
            ...
            GestureDetector(
              onTap: () {
                settingModalBottomSheet(context,createPostController);
              },
              child: Padding(
                padding:
            ...
            Padding(
              ...
              child: GestureDetector(
                onTap: (){
                  createPostController.createPost(context);
                },
                child: Container(
                  height: 50,
                  width: MediaQuery.of(context).size.width,
                  ...
                  child: Center(
                    child: createPostController.isCreatePost ==false?
                    const Text(
                      "Create post",
                      style: TextStyle(
                          fontSize: 15,
